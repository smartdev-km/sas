...
def create_app(config_class=Config):
    ...
    def inject_compteurs_validation():
        ...
        from app.models import Depense, TransactionBancaire, SuiviConsommable, FactureFournisseur, Salaire, DemandeAbsence, EvenementAgenda, DemandeCarburant
        return {
            ...
            "nb_demandes_carburant_en_attente": DemandeCarburant.query.filter_by(statut="en_attente").count(),
